...
Oiq.prototype.initialize = function() {
  ...
  oiq.src = document.location.protocol + '//px.owneriq.net/stas/s/'+opts.dataGroupId+'.js';
...
Oiq.prototype.page = function() {
  var opts = this.options;
  window._oiqq = window._oiqq || [];
  window._oiqq.push(['oiq_addPageLifecycle', opts.dataGroupId]);
...
Oiq.prototype.orderCompleted = function(track) {
  ...
  oiq_conv.src = 'https://px.owneriq.net/j?pt='+opts.dataGroupId+'&s='+opts.tagId+'&sConvTitle='+title+'&cnv=true';
