...
Oiq.prototype.orderCompleted = function(track) {
  ...
  for (var i=0; i<products.length; i++) {
    ...
    push(['oiq_addCustomKVP',['brand_'+index,productTrack.brand()]]);
    ...
    push(['oiq_addCustomKVP',['id_'+index,productTrack.sku()]]);
    push(['oiq_addCustomKVP',['price_'+index,productTrack.price()]]);
    push(['oiq_addCustomKVP',['product_type_'+index,productTrack.category()]]);
    push(['oiq_addCustomKVP',['quantity_'+index,productTrack.quantity()]]);
    push(['oiq_addCustomKVP',['title_'+index,productTrack.name()]]);
